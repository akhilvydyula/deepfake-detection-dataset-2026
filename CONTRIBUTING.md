# Contributing to Deepfake Detection Dataset 2026

Thank you for helping improve **Deepfake Detection Dataset 2026**! This project is part of the
...
```bash
git clone https://github.com/akhilvydyula/deepfake-detection-dataset-2026.git
cd deepfake-detection-dataset-2026
python -m venv .venv
...
- [GitHub Discussions](https://github.com/akhilvydyula/deepfake-detection-dataset-2026/discussions) for Q&A
